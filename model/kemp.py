...
import numpy as np
import math
from model.common import EncoderLayer, DecoderLayer, MultiHeadAttention, Conv, PositionwiseFeedForward, LayerNorm , _gen_bias_mask ,_gen_timing_signal, share_embedding, LabelSmoothing, NoamOpt, _get_attn_subsequent_mask
...
class KEMP(LightningModule):
    def __init__(self,vocab, decoder_number, args=config.args):
